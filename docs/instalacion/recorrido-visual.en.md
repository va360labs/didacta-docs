...
![Setup wizard welcome screen](../assets/recorrido-visual/01-setup-intro.png)

The second step asks for the organization name and the public domain (the host you are connecting from, editable).

![Organization step: name and public domain](../assets/recorrido-visual/02-setup-organizacion.png)
...
![Administrator account step: name, email and password](../assets/recorrido-visual/03-setup-admin.png)
...
![Final wizard screen: platform created](../assets/recorrido-visual/04-setup-listo.png)
...
![Onboarding: uploading a profile photo](../assets/recorrido-visual/05-onboarding-foto.png)
...
![Sign-in screen with the tenant's branding](../assets/recorrido-visual/06-signin.png)
...
![Creating a new course, in draft](../assets/recorrido-visual/08-curso-nuevo.png)

Inside the course you add sections and, within each section, lessons — here, a text lesson.

![Course builder: adding a text lesson](../assets/recorrido-visual/09-curso-leccion-alta.png)
...
![Publishing checklist complete](../assets/recorrido-visual/10-curso-listo-publicar.png)

Once everything is in place, the course moves to **Published**.

![Course published](../assets/recorrido-visual/11-curso-publicado.png)
...
![Invitation code generated for the course](../assets/recorrido-visual/12-curso-invitacion-generada.png)
...
![Empty public sales catalog: this course has no price configured](../assets/recorrido-visual/13-catalogo-publico.png)
...
![Adding a student through an individual invitation](../assets/recorrido-visual/14-admin-invitar-alumna.png)

## 7 · The student signs in and enrolls

From the link in the email, the student sets her password.

![The student sets her password from the email link](../assets/recorrido-visual/15-alumna-definir-password.png)
...
![Internal catalog at /cursos, signed in](../assets/recorrido-visual/16-alumna-catalogo.png)

On the course page, she redeems the invitation code the organization gave her.

![Redeeming the invitation code on the course page](../assets/recorrido-visual/17-alumna-canjear-codigo.png)

Redeeming it enrolls her instantly and shows her progress dashboard.

![Student enrolled: progress dashboard](../assets/recorrido-visual/18-alumna-matriculada.png)
...
![Text lesson content](../assets/recorrido-visual/19-alumna-leccion.png)
...
![Course completed: certificate ready to download](../assets/recorrido-visual/20-alumna-curso-completado.png)

All of a student's certificates are also kept at `/mis-certificados`, with a verifiable sequential number.

![/mis-certificados with the issued certificate](../assets/recorrido-visual/21-alumna-mis-certificados.png)
