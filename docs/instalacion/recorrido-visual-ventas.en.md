...
![SMTP form filled in, TLS disabled for an unencrypted server](../assets/notificaciones-y-pagos/02-smtp-form.png)
...
!["Configured but not verified" banner after saving](../assets/notificaciones-y-pagos/03-smtp-guardado.png)

**"Send test email"** confirms the configuration really works: it opens a dialog with the admin's own email pre-filled.

![Test send dialog with the recipient pre-filled](../assets/notificaciones-y-pagos/04-smtp-modal-prueba.png)
...
!["Verified" banner with date and time](../assets/notificaciones-y-pagos/05-smtp-verificado.png)

And the email, for real, in the mailbox:

![The test email, for real, in the Mailpit inbox](../assets/notificaciones-y-pagos/06-mailpit-bandeja.png)
...
- **Membership** (`/admin/membresia`) shows a notice at the very top — plans and the `/unete` page are prepared all the same, but the actual charge will fail until you configure Stripe.
  ...
  ![Stripe-not-configured notice on /admin/membresia](../assets/notificaciones-y-pagos/08-membresia-aviso-stripe.png)
...
![Payments form with test credentials, before saving](../assets/notificaciones-y-pagos/10-pagos-form-relleno.png)
...
!["Configured but not verified" banner after saving](../assets/notificaciones-y-pagos/11-pagos-guardado-sin-verificar.png)
...
![Stripe rejects a made-up key with its own error message](../assets/notificaciones-y-pagos/12-pagos-probar-conexion-error.png)
...
![Creating the "Acceso completo" access group (all courses)](../assets/notificaciones-y-pagos/13-grupo-acceso.png)
...
![Creating a monthly plan: €19 (was €29), 7-day trial](../assets/notificaciones-y-pagos/14-membresia-plan-form.png)

![The plan created and listed](../assets/notificaciones-y-pagos/15-membresia-plan-creado.png)
...
![Configuration of the public /unete page](../assets/notificaciones-y-pagos/16-unete-config.png)

![The /unete page live after saving](../assets/notificaciones-y-pagos/17-unete-config-guardada.png)
