...
| No emails arrive | In the default installation, emails go to the local Mailpit instance (`http://localhost:8025`), not to the internet. Configure a real SMTP server under **Administration → Settings → Notifications**. |
