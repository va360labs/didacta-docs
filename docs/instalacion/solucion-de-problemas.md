...
| No llegan los correos | En la instalación por defecto los correos van al Mailpit local (`http://localhost:8025`), no a internet. Configura SMTP real en **Administración → Configuración → Notificaciones**. |
