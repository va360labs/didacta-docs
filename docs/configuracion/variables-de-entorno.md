...
| `DIDACTA_IMAGE_TAG` | No | la versión recomendada del repo | compose | Tag de la imagen `ghcr.io/va360labs/didacta-community` que levanta el compose. Fija siempre una versión concreta. |
