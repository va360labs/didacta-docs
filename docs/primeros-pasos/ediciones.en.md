...
With a JWT license signed by VA360 LABS, pasted into **Administration → License** or pinned in the `DIDACTA_LICENSE_KEY` variable. The details are in [Enterprise license](../enterprise/licencia.md).
